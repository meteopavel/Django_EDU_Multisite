...
Константы:
- `SUBJECT_DEFAULTS = {'psychology': ('09:00', '12:00'), 'medicine': ('17:00', '20:00')}`
...
- `ClassSessionAdmin(admin.ModelAdmin)`
...
# edu_multisite/local_settings.py

Модуль:
Локальный override настроек. Не коммитится — машинно-специфичный (в .gitignore).

Переключатель между докер-контейнерами на homerouter и локально на Mac.
